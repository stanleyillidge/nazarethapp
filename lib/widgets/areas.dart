...
class AreasList extends StatefulWidget {
  const AreasList({Key? key, this.nombre, this.lista}) : super(key: key);
  final List<Area>? lista;
  final String? nombre;
  @override
  AreasListState createState() => AreasListState();
}

class AreasListState extends State<AreasList> {
  // init() async {
  //   areas = [];
  ...
  String? borrado = '';
  String? editado = '';
  final ScrollController? _areaScrollController =
      ScrollController(initialScrollOffset: 0.0);
  final ScrollController? _areaLv1ScrollController =
      ScrollController(initialScrollOffset: 0.0);
  @override
                    ...
                    ? Container(
                        ...
                        child: Padding(
                          ...
                          child: ListView.builder(
                            controller: _areaLv1ScrollController,
                            shrinkWrap: true,
...
class _AsignaturasListState extends State<AsignaturasList> {
  ...
  final ScrollController? _areaLv2ScrollController =
      ScrollController(initialScrollOffset: 0.0);
  List<TextEditingController> nombres = [];
      ...
      children: <Widget>[
        ...
        widget.lista!.isNotEmpty
            ? Padding(
                ...
                child: ListView.builder(
                  controller: _areaLv2ScrollController,
                  shrinkWrap: true,
                  itemCount: widget.lista!.length,
                  itemBuilder: (context, i) {
                    return Card(
